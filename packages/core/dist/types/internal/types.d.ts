...
import type { Abi, AbiEvent, AbiFunction, Address, BlockTag, Hex, LogTopic, RpcBlock, RpcTransaction, RpcTransactionReceipt, Transport, Chain as ViemChain, Log as ViemLog } from "viem";
...
export type TransactionFilter<fromFactory extends Factory | undefined = Factory | undefined, toFactory extends Factory | undefined = Factory | undefined> = {
    ...
    include: (`block.${keyof Block}` | `transaction.${keyof Transaction}` | `transactionReceipt.${keyof TransactionReceipt}`)[];
};
export type TraceFilter<fromFactory extends Factory | undefined = Factory | undefined, toFactory extends Factory | undefined = Factory | undefined> = {
    ...
    include: (`block.${keyof Block}` | `transaction.${keyof Transaction}` | `transactionReceipt.${keyof TransactionReceipt}` | `trace.${keyof Trace}`)[];
};
export type LogFilter<factory extends Factory | undefined = Factory | undefined> = {
    ...
    toBlock: number | undefined;
    hasTransactionReceipt: boolean;
    include: (`block.${keyof Block}` | `transaction.${keyof Transaction}` | `transactionReceipt.${keyof TransactionReceipt}` | `log.${keyof Log}`)[];
};
...
export type FragmentAddressId = Address | `${Address | null}_${Factory["eventSelector"]}_${Factory["childAddressLocation"]}` | null;
...
export type Chain = {
    ...
    maxLogsPerRequest: number | undefined;
...
export type RequiredTransactionColumns = "transactionIndex" | "from" | "to" | "hash" | "type";
export type RequiredTransactionReceiptColumns = "status" | "from" | "to";
export type RequiredTraceColumns = "from" | "to" | "input" | "output" | "value" | "type" | "error" | "traceIndex";
export type RequiredLogColumns = keyof Log;
export type RequiredInternalBlockColumns = RequiredBlockColumns;
export type RequiredInternalTransactionColumns = RequiredTransactionColumns | "blockNumber";
export type RequiredInternalTransactionReceiptColumns = RequiredTransactionReceiptColumns | "blockNumber" | "transactionIndex";
export type RequiredInternalTraceColumns = RequiredTraceColumns | "blockNumber" | "transactionIndex";
export type RequiredInternalLogColumns = RequiredLogColumns | "blockNumber" | "transactionIndex";
export type InternalBlock = PartialExcept<Block, RequiredBlockColumns>;
export type InternalTransaction = PartialExcept<Transaction, RequiredTransactionColumns> & {
    blockNumber: number;
};
export type InternalTransactionReceipt = PartialExcept<TransactionReceipt, RequiredTransactionReceiptColumns> & {
    blockNumber: number;
...
export type UserTransaction = PartialExcept<Transaction, RequiredTransactionColumns>;
export type UserTransactionReceipt = PartialExcept<TransactionReceipt, RequiredTransactionReceiptColumns>;
...
export type Event = BlockEvent | TransactionEvent | TraceEvent | LogEvent | TransferEvent;
