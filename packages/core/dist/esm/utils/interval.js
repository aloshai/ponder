 ...
 */
export function intervalSum(intervals) {
    let totalSum = 0;
 ...
 */
export function intervalUnion(intervals_) {
 ...
 */
export function intervalIntersection(list1, list2) {
    const result = [];
    let i = 0;
    let j = 0;
 ...
 * @returns Intersection of the intervals, represented as a list of intervals.
 */
export function intervalIntersectionMany(lists) {
    if (lists.length === 0)
        return [];
    if (lists.length === 1)
        return lists[0];
 ...
 */
export function intervalDifference(initial, remove) {
 ...
 */
export function intervalBounds(intervals) {
...
export function getChunks({ interval, maxChunkSize, }) {
    const _chunks = [];
...
export function intervalRange(interval) {
